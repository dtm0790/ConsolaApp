...
namespace HelloWS
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://learnwebservices.com/services/hello", ConfigurationName="HelloWS.HelloEndpoint")]
    public interface HelloEndpoint
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        HelloWS.SayHelloResponse SayHello(HelloWS.SayHello request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<HelloWS.SayHelloResponse> SayHelloAsync(HelloWS.SayHello request);
    }
    ...
    public partial class SayHello
    {
        ...
        public HelloWS.helloRequest HelloRequest;
        
        public SayHello()
        {
        }
        
        public SayHello(HelloWS.helloRequest HelloRequest)
        {
    ...
    public partial class SayHelloResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://learnwebservices.com/services/hello", Order=0)]
        public HelloWS.helloResponse HelloResponse;
        
        public SayHelloResponse()
        {
        }
        
        public SayHelloResponse(HelloWS.helloResponse HelloResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface HelloEndpointChannel : HelloWS.HelloEndpoint, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class HelloEndpointClient : System.ServiceModel.ClientBase<HelloWS.HelloEndpoint>, HelloWS.HelloEndpoint
    {
        ...
        public HelloWS.SayHelloResponse SayHello(HelloWS.SayHello request)
        {
            return base.Channel.SayHello(request);
        }
        
        public System.Threading.Tasks.Task<HelloWS.SayHelloResponse> SayHelloAsync(HelloWS.SayHello request)
        {
